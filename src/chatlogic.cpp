...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot _chatBot1("../images/chatbot.png");
    // add pointer to chatlogic so that chatbot answers can be passed on to the GUI
    SetChatbotHandle(&_chatBot1);
    _chatBot1.SetChatLogicHandle(this);
    _chatBot1.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(_chatBot1));
